...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed top-0 left-0 h-full md:top-2 md:left-2 md:h-[98%] bg-purple-300 w-72 p-4 z-50 transition-transform duration-300 ease-in-out
      ...
      >
        <div className="flex flex-col justify-between h-full">
          ...
          <div className="mt-6">
            <button
              onClick={logout}
              className="w-full px-4 py-2 text-gray-700 hover:bg-red-600 hover:text-white rounded"
            >
              Logout
            </button>
          </div>
