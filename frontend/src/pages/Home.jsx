...
//       icon: Brain,
//       title: "Resume Maker",
//       description: "Upload your resume and let our AI extract skills, experience, and match you with perfect opportunities."
//     },
//     {
//       icon: Search,
...
//       description: "Get tailored job and hackathon notifications delivered to your inbox on your schedule."
//     },
//   ];
...
//       {/* Navigation */}
//       <nav className="px-6 py-4 relative z-50 backdrop-blur-md bg-white/5 border-b border-white/10">
...
//             </div>
//             <span className="text-2xl font-bold bg-gradient-to-r from-white to-purple-200 bg-clip-text text-transparent">FutureForge</span>
//           </div>

//           {/* Desktop Menu */}
//           <div className="hidden md:flex items-center space-x-8">
//             <a href="#About Us" className="hover:text-purple-300 transition-all duration-300 text-gray-200 font-medium relative group">
//               About Us
//               <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-purple-400 to-blue-400 group-hover:w-full transition-all duration-300"></span>
//             </a>
//             <a href="#features" className="hover:text-purple-300 transition-all duration-300 text-gray-200 font-medium relative group">
//               Features
//               <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-purple-400 to-blue-400 group-hover:w-full transition-all duration-300"></span>
//             </a>
//             <a href="#testimonials" className="hover:text-purple-300 transition-all duration-300 text-gray-200 font-medium relative group">
//               Testimonials
//               <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-purple-400 to-blue-400 group-hover:w-full transition-all duration-300"></span>
//             </a>
//             <button className="bg-gradient-to-r from-white to-gray-100 text-purple-900 px-8 py-3 rounded-full font-semibold hover:shadow-2xl transition-all duration-300 transform hover:scale-105 border border-white/20">
//               Login
//             </button>
//           </div>
...
//           {/* Mobile Menu Button */}
//           <button 
//             className="md:hidden bg-white/10 p-2 rounded-lg backdrop-blur-sm border border-white/20 hover:bg-white/20 transition-all duration-300"
...
//         {/* Mobile Menu */}
//         {isMenuOpen && (
//           <div className="md:hidden absolute top-full left-0 right-0 bg-black/90 backdrop-blur-xl p-6 border-t border-white/10">
//             <div className="flex flex-col space-y-4">
//               <a href="#About Us" className="hover:text-purple-300 transition-colors py-2 text-gray-200 font-medium">About Us</a>
//               <a href="#features" className="hover:text-purple-300 transition-colors py-2 text-gray-200 font-medium">Features</a>
//               <a href="#testimonials" className="hover:text-purple-300 transition-colors py-2 text-gray-200 font-medium">Testimonials</a>
//               <button className="bg-gradient-to-r from-white to-gray-100 text-purple-900 px-6 py-3 rounded-full font-semibold mt-4">
//                 Login
//               </button>
//             </div>
//           </div>
...
//             Upload your resume, discover perfect job matches, track hackathons, and get personalized career guidance - all powered by advanced AI.
//           </p>
...
//           {/* Heading */}
//           <h2 className="text-4xl md:text-5xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-blue-600">
//             About FutureForge
//           </h2>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-indigo-900 to-purple-900 text-white overflow-hidden">
      ...
      <section id='About Us' className="px-6 py-16 bg-gradient-to-br from-white via-gray-50 to-blue-50 text-gray-800 relative">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          {/* Heading */}
          <h2 className="text-4xl mt-6 md:text-5xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-blue-600">
            About FutureForge
          </h2>
          <p className="text-gray-600 text-xl  mb-8 font-medium">
            Bridging the gap between education and career success
