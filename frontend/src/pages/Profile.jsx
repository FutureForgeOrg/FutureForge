...
export default function Profile() {
  ...
  const { data: completionData, isLoading: isProfileCompletionStausLoading } = useProfileCompletion();
    ...
    <div className="text-white">
      <BackgroundWrapper>
        ...
        <div className="p-6 mx-auto">
          <h2 className="pt-16 text-4xl text-center mb-2 font-bold font-heading tracking-wide">Your Profile</h2>

          {isProfileCompletionStausLoading ? (
            <div className="max-w-3xl text-center mx-auto">
              <div className="bg-yellow-100 p-4 rounded-md mb-4">
                <h3 className="font-semibold text-yellow-700">Loading profile status...</h3>
                <div className="w-full bg-gray-200 rounded-full h-3 mt-2">
                  <div className="bg-yellow-500 h-3 rounded-full animate-pulse" style={{ width: `50%` }}></div>
                </div>
              </div>
            </div>
          ) : (
              ...
              <div className="max-w-3xl text-center mx-auto">
                <div className="bg-yellow-100 p-4 rounded-md mb-4">
                  ...
                  <p className="text-yellow-600">
                    Your profile is {completion}% complete. Add missing details to get to 100%, so that you can easily auto fill details in <span className="text-blue-600">resume</span> and <span className="text-blue-600">portfolio maker</span>.
                  </p>
                  <div className="w-full bg-gray-200 rounded-full h-3 mt-2">
                    <div
          ...
          <div className={`max-w-3xl mx-auto p-8 ${completion < 100 ? "pt-6" : "pt-4"} bg-white/10 rounded-lg`}>
            {!isEditing ? (
              <>
                <h1 className="text-3xl font-bold">{profile?.name || authUser.username}</h1>
