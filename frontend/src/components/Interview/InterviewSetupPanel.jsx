...
function InterviewSetupPanel() {
  ...
  const roles = [
    ...
    "Software Architect", "UI/UX Designer", "Site Reliability Engineer",
    ...
    <div className="bg-white rounded-lg border-2 border-gray-200 p-8 mt-16">
      ...
      <div className="mb-6">
        ...
        <div className="mb-4">
          ...
          >
            <option value="">Mention roles (approximately 20)</option>
            {roles.map((role) => (
        ...
        <div>
          ...
          <select
            ...
            className="w-full p-3 border border-gray-300 rounded-lg disabled:bg-gray-100"
          >
            <option value="">Mention topics (approximately 20)</option>
            {topics.map((topic) => (
      ...
      <div className="text-center">
        ...
        >
          {isProcessing ? 'Generating...' : 'Submit and Generate Question'}
        </button>
      </div>
    </div>
    </>
